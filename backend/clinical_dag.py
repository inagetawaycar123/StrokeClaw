...
BASE_NODES = {
    ...
    "mrs_prognosis": _node(
        "mrs_prognosis",
        "90天功能预后评估",
        agent="Clinical Prognosis Agent",
        skill_id="SKILL_MRS_PROGNOSIS",
        doctor_review_required=True,
    ),
...
PATH_CONFIGS = {
    "ncct_only": {
        ...
        "columns": [["image_qc"], ["ncct_triage"], ["mrs_prognosis"], ["internal_check", "guideline_check"], ["report"]],
        "edges": [
            ("image_qc", "ncct_triage"),
            ("ncct_triage", "mrs_prognosis"),
            ("mrs_prognosis", "internal_check"),
    ...
    "ncct_single_phase_cta": {
        ...
        "edges": [
            ...
            ("vessel_occlusion", "mrs_prognosis"),
            ("mrs_prognosis", "internal_check"),
