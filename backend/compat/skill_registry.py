...
SKILL_REGISTRY: List[Dict[str, object]] = [
    ...
    },
    {
        ...
        "skill_name": "collateral_score",
        "skill_type": "algorithm",
        "owner_agent": "Vascular Agent",
        "clinical_task": "collateral_circulation_assessment",
        "required_input": ["multiphase_mcta_series"],
        "main_output": ["collateral_score_code", "phase_quality_score"],
        "confidence_method": "classification_probability_and_phase_quality",
        "confidence_threshold": 0.75,
        "failure_strategy": "fallback_to_manual_review",
        "version": "0.8.0",
        "status": "inactive",
    ...
    },
    {
        ...
        "skill_name": "mrs_90day_prognosis_prediction",
        "skill_type": "algorithm",
        "owner_agent": "Clinical Prognosis Agent",
        "clinical_task": "mrs_90day_binary_risk_prediction",
        "required_input": ["clinical_schema_v0_2", "ncct_for_update_24h"],
        "main_output": ["poor_prognosis_risk", "predicted_class", "confidence"],
        "confidence_method": "three_seed_ensemble_disagreement_and_threshold_margin",
        "confidence_threshold": 0.7,
        "failure_strategy": "return_unavailable_or_explicit_update_to_baseline_fallback",
        "version": "MVP_RESEARCH",
        "status": "active",
        "doctor_review_required": True,
    },
    {
...
TOOL_TO_SKILL_ID = {
    ...
    "collateral_score": "SKILL_COLLATERAL_SCORE",
    "run_stroke_analysis": "SKILL_STROKE_ANALYSIS",
    "run_mrs_prognosis_prediction": "SKILL_MRS_PROGNOSIS",
